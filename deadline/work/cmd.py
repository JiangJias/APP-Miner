...
def CMDParser():
    ...
    parser.add_argument("-iquote", type=str, default=None)
    ...
    parser.add_argument("-prefer-non-pic", action="store_true")
    parser.add_argument("-prefer-pic", action="store_true")
    parser.add_argument("-rpath", type=str, default=None)
    parser.add_argument("-avoid-version", action="store_true")
    parser.add_argument("-export-symbols-regex", type=str, default=None)
